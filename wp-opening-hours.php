<?php
/*
 * Plugin Name: Opening Hours NG
 * Plugin URI: https://github.com/janizde/WP-Opening-Hours
 * Description: Manage your venue's Opening Hours, Holidays and Irregular Openings in WordPress and display them in many different Widgets and Shortcodes (now also with irregular closings)
 * Version: 3.0.0
...
function op_admin_notice_php() {
  $string = __(
    'Plugin Opening Hours requires at least PHP Version %s. Your Installation of WordPress is currently running on PHP %s',
    'wp-opening-hours'
  );
...
function op_admin_notice_wp() {
  global $wp_version;
  $string = __(
    'Plugin Opening Hours requires at least WordPress version %s. Your Installation of WordPress is running on WordPress %s',
    'wp-opening-hours'
  );
